...
var Quotes = function Quotes() {
  ...
  (0, _react.useEffect)(function () {
    var fetchQuote = /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var apiKey, category, res, json;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              setIsLoading(true);
              _context.prev = 1;
              apiKey = 'e83m5BX9Ww3ih5whVCbdrbqAnJrxlEDYJZ0tAY7w';
              category = 'success';
              _context.next = 6;
              return fetch("https://api.api-ninjas.com/v1/quotes?category=".concat(category), {
                headers: {
                  'X-Api-Key': apiKey
                }
              });
  ...
  if (hasError) return /*#__PURE__*/React.createElement("div", {
    className: "qouteName"
